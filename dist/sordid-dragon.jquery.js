...
(function($) {
  return $.fn.sordidDragon = function(command, options) {
    var $activePlaceholderChild, $ghost, $parent, $placeholder, calculatePositions, currentPosition, hideGhost, hidePlaceholder, isDragging, isTouch, moveChild, positions, showGhost, showPlaceholder;
    if (command == null) {
      command = "enable";
    }
    if (options == null) {
