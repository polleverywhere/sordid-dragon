...
(function($) {
  ...
  return $.fn.sordidDragon = function(command, options) {
    var $activePlaceholderChild, $ghost, $ghostContainer, $parent, $placeholder, calculatePositions, currentPosition, hideGhost, hidePlaceholder, isDragging, moveChild, positions, showGhost, showPlaceholder;
    if (command == null) {
      command = "enable";
    }
    if (options == null) {
    ...
    showGhost = function(pageY) {
      if (!$ghost.is(":visible")) {
        $ghost.addClass("sordidDragon-ghost").css({
          position: "fixed",
          opacity: 1
        });
